...
public class GetUserByActivityActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_user_by_activityy);

        final Spinner spinnerSetActivity = (Spinner) findViewById(R.id.spinnerActivityGetUserByActivity);
        final Button btGetUsersByActivity = (Button) findViewById(R.id.btGetUsersByActivityGetUsersByActivity);
        final RequestQueue requestQueue = Volley.newRequestQueue(this);

        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.activity_array, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSetActivity.setAdapter(adapter);
        ...
        btGetUsersByActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String activity = "";
                if ("Active".equals(spinnerSetActivity.getSelectedItem().toString())){
                    activity = "true";
                }else activity = "false";
                final JSONArray[] jsonArray = {null};
                String url = getString(R.string.ip)+"/projektz/users/getByActivity/"+activity;
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                final ListView listview = (ListView) findViewById(R.id.listviewShowUsersByActivity);
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(GetUserByActivityActivity.this,
