...
public class UpdateProjectForUserActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_project_for_user);
        ...
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final ListView listview = (ListView) findViewById(R.id.listViewUpdateProjectForUser);
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(UpdateProjectForUserActivity.this,
                        ...
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent intent  = new Intent(UpdateProjectForUserActivity.this, UpdateProjectForUserProjectListActivity.class);
                                intent.putExtra("id",value);
                                UpdateProjectForUserActivity.this.startActivity(intent);
                            }
                        });
                    }
