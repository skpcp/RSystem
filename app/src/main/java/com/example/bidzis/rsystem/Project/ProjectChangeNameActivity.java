        ...
        JsonArrayRequest request2 = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final ListView listview = (ListView) findViewById(R.id.lvProjectChangeName);
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(ProjectChangeNameActivity.this,
