...
//                                    String PriorityResponseTime = jsonObject.getString("responseTime");
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(PriorityChangePriorityName.this,
                        ...
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent intent = new Intent(PriorityChangePriorityName.this, PriorityChangePriorityNameWindow.class);
                                intent.putExtra("id", aId);
                                PriorityChangePriorityName.this.startActivity(intent);
