...
public class GetUserByNameAndSurnameActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_user_by_name_and_surname);

        final EditText etName = (EditText) findViewById(R.id.etNameGetUserByNameAndSurname);
        final EditText etSurname = (EditText) findViewById(R.id.etSurnameGetUserByNameAndSurname);

        final Button btGetUser = (Button) findViewById(R.id.btShowUserGetUserByNameAndSurname);
        ...
        assert btGetUser != null;
        btGetUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = getString(R.string.ip) + "/projektz/users/getByNameAndSurname/" + etName.getText().toString()+","+etSurname.getText().toString();
                ...
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                final ListView listview = (ListView) findViewById(R.id.listviewShowUsersByNameAndSurname);
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(GetUserByNameAndSurnameActivity.this,
