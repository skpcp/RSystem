        ...
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final ListView listview = (ListView) findViewById(R.id.listviewRemoveUsers);
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(RemoveUsersActivity.this,
...
//                                    }else break;
//                                }
                                String url = getString(R.string.ip)+"/projektz/users/removeUserById/"+aId;
                                JsonObjectRequest request = new JsonObjectRequest
                                        (Request.Method.POST, url, null, new Response.Listener<JSONObject>() {

                                            @Override
                                            public void onResponse(JSONObject response) {
                                                Toast.makeText(getApplicationContext(), "Remove User Succesful",
