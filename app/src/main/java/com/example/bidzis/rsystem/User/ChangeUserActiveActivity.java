...
public class ChangeUserActiveActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_change_user_active);
        ...
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final ListView listview = (ListView) findViewById(R.id.listviewChangeUserActive);
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(ChangeUserActiveActivity.this,
                        ...
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent intent  = new Intent(ChangeUserActiveActivity.this, ChangeUserActiveWindowActivity.class);
                                intent.putExtra("id",aId);
                                ChangeUserActiveActivity.this.startActivity(intent);
                            }
                        });
                    }
