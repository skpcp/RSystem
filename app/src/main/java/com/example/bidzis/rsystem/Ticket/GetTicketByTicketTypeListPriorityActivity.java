...
import com.example.bidzis.rsystem.User.ChangeUserActiveWindowActivity;
...
public class GetTicketByTicketTypeListPriorityActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_get_ticket_by_ticket_type_list_priority);
        ...
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        if (jsonArray[0] != null) {
                            ...
                            for (int i=0;i<len;i++){
                                try {
                                    ...
                                    value.add(i, jsonObject[0].getString("name")+"\nResponse Time: "+jsonObject[0].getString("responseTime"));
                        ...
                        final ListView listview = (ListView) findViewById(R.id.listViewGetTicketByTypeListPriority);
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(GetTicketByTicketTypeListPriorityActivity.this,
                        ...
                        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent intent  = new Intent(GetTicketByTicketTypeListPriorityActivity.this, GetTicketsByPriorityActivity.class);
                                intent.putExtra("id",value);
                                GetTicketByTicketTypeListPriorityActivity.this.startActivity(intent);
                            }
                        });
                    }
