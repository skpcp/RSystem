...
public class GetTicketsByProjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = getString(R.string.ip)+"/projektz/tickets/getTicketsByProject/"+aIdUser;
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final ListView listview= (ListView) findViewById(R.id.listViewGetTicketsByProject);
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(GetTicketsByProjectActivity.this,
