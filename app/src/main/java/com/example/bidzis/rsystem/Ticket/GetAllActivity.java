...
public class GetAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listViewGetAll = (ListView) findViewById(R.id.listViewGetAll);
        ...
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        final ListView listview = (ListView) findViewById(R.id.listViewGetAll);
                        ...
                        final StableArrayAdapter adapter = new StableArrayAdapter(GetAllActivity.this,
