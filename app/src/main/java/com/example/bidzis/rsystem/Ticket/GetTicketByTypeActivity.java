...
public class GetTicketByTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.ticketType_array, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerSelectTicketTypeGetTicketByType.setAdapter(adapter);

        final RequestQueue requestQueue = Volley.newRequestQueue(this);

        assert btGetTicketGetTicketByType != null;
        btGetTicketGetTicketByType.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                final JSONArray[] jsonArray = {null};

                String url = getString(R.string.ip)+"/projektz/tickets/getByTicketType/"+spinnerSelectTicketTypeGetTicketByType.getSelectedItem().toString();
                JsonArrayRequest request = new JsonArrayRequest
                        (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                final ListView listview = (ListView) findViewById(R.id.listViewGetTicketByType);
                                ...
                                final StableArrayAdapter adapter = new StableArrayAdapter(GetTicketByTypeActivity.this,
